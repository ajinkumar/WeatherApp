...
import com.example.weatherapp.model.WeatherViewHolder;
import com.example.weatherapp.ui.MainActivity;
import com.example.weatherapp.ui.WeatherDetailsActivity;
    ...
    public void onBindViewHolder(WeatherViewHolder customViewHolder, int i) {
        ...
        customViewHolder.mainLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                context.startActivity(new Intent(context, WeatherDetailsActivity.class)
                        .putExtra("weatherData", weatherItem));
            }
        });
        ...
        if (sp.getString("speedUnit", "m/s").equals("bft")) {
            customViewHolder.itemWind.setText(context.getString(R.string.wind) + ": " +
                    UnitConverter.getBeaufortName((int) wind) + " " + MainActivity.getWindDirectionString(sp, context, weatherItem));
        } else {
            customViewHolder.itemWind.setText(context.getString(R.string.wind) + ": " + new DecimalFormat("0.0").format(wind) + " " +
